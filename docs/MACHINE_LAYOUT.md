...
adds the selected head midpoint minus the camera midpoint directly to the recorded camera XY.
Both axes use this same offset direction, without rotation or scaling.
Stored bolt coordinates and SDK Unit/Pulse are unchanged. Each bolt
