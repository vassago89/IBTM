...
1. Supply picks while Rotated, unrotates at Rotation Z, reaches give Z, then give XY.
...
6. Supply waits for Placement Handler Up, returns XY at give Z to the next pickup, then reaches Rotation Z and rotates for pickup.
