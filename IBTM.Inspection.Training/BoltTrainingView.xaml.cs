...
public partial class BoltTrainingView : UserControl
{
    ...
    private void FitImage(object sender, RoutedEventArgs e)
    {
        MaskEditor.FitImage();
    }

    private void FitRegion(object sender, RoutedEventArgs e)
    {
        MaskEditor.FitRegion();
    }

    private void SelectSample(object sender, SelectionChangedEventArgs e)
    {
        if (DataContext is BoltTrainingViewModel model
            && ((ComboBox)sender).SelectedItem is BoltSampleInfo sample
