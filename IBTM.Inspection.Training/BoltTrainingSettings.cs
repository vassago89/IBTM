...
{
    [Description("Off")] Off,
    [Description("All Inspections")] All,
    [Description("NG Only")] NgOnly,
}

public sealed partial class BoltTrainingSettings : ObservableObject
{
    [ObservableProperty] private InspectionImageCollection _imageCollection;
    [ObservableProperty] private int _maxEpochs = 50;
    [ObservableProperty] private int _batchSize = 8;
    [ObservableProperty] private double _learningRate = 0.001;
    [ObservableProperty] private int _patience = 10;
    [ObservableProperty] private float _maskThreshold = 0.5f;
    ...
    [JsonIgnore]
    public bool IsValid => MaxEpochs > 0 && BatchSize > 0 && Patience > 0
